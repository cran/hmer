...
#>  [1] -5.911938e-15 -7.882583e-15 -2.187139e-14 -4.374279e-14 -5.573320e-14 -3.552714e-14 -1.160183e-14  9.992007e-16
#>  [9]  9.325873e-15 -2.220446e-16
...
![plot of chunk plot-1d-first](lowdim-plot-1d-first-1.png)
...
#> Proposing from LHS...
#> 40 initial valid points generated for I=3
...
![plot of chunk plot-1d-results-first](lowdim-plot-1d-results-first-1.png)
...
![plot of chunk wave-2-1d](lowdim-wave-2-1d-1.png)
...
#> Proposing from LHS...
#> 29 initial valid points generated for I=3
#> Selecting final points using maximin criterion...
...
![plot of chunk gen-1d-points-2](lowdim-gen-1d-points-2-1.png)
...
#> Parameters and ranges:  x: c(-1.5708, 1.5708): y: c(-1, 1) 
#> Specifications: 
#> 	 Basis functions:  (Intercept); x; y; I(x^2); I(y^2); x:y 
#> 	 Active variables x; y 
#> 	 Regression Surface Expectation:  -3.3511; -0.1242; 0.0779; 1.0988; 1.0975; 0.8124 
#> 	 Regression surface Variance (eigenvalues):  0; 0; 0; 0; 0; 0 
#> Correlation Structure: 
#> Bayes-adjusted emulator - prior specifications listed. 
#> 	 Variance (Representative):  0.1383129 
#> 	 Expectation:  0 
#> 	 Correlation type: exp_sq 
#> 	 Hyperparameters:  theta: 0.5172 
#> 	 Nugget term: 0 
...
![plot of chunk validate-2d-ems](lowdim-validate-2d-ems-1.png)
...
![plot of chunk changed-2d-validation](lowdim-changed-2d-validation-1.png)
...
![plot of chunk plot-2d-ems](lowdim-plot-2d-ems-1.png)

```r
emulator_plot(ems2d, plot_type = 'sd')
```

![plot of chunk plot-2d-ems](lowdim-plot-2d-ems-2.png)
...
![plot of chunk plot-2d-ems-with-augment](lowdim-plot-2d-ems-with-augment-1.png)
...
![plot of chunk plot-2d-ems-corr](lowdim-plot-2d-ems-corr-1.png)
...
![plot of chunk plot-2d-ems-imp](lowdim-plot-2d-ems-imp-1.png)

```r
emulator_plot(ems2d, plot_type = 'nimp', targets = targets2d)
```

![plot of chunk plot-2d-ems-imp](lowdim-plot-2d-ems-imp-2.png)
...
![plot of chunk gen-2d-points-first](lowdim-gen-2d-points-first-1.png)
...
#> 	 Basis functions:  (Intercept) 
#> 	 Active variables x; y 
#> 	 Regression Surface Expectation:  -2.8959 
#> 	 Regression surface Variance (eigenvalues):  0 
#> Correlation Structure: 
#> Bayes-adjusted emulator - prior specifications listed. 
#> 	 Variance (Representative):  0.04032869 
#> 	 Expectation:  0 
#> 	 Correlation type: exp_sq 
...
![plot of chunk validate-2d-ems-2](lowdim-validate-2d-ems-2-1.png)
...
![plot of chunk plot-2d-imp-2](lowdim-plot-2d-imp-2-1.png)

Finally, we propose points from a combination of this wave and the previous wave.


```r
new_new_points2d <- generate_new_runs(c(ems2d_2, ems2d), 40, targets2d, resample = 0)
#> Proposing from LHS...
#> 157 initial valid points generated for I=3
#> Selecting final points using maximin criterion...
plot_wrap(new_new_points2d, ranges2d)
```

![plot of chunk gen-2d-points-2](lowdim-gen-2d-points-2-1.png)
...
![plot of chunk plot-2d-waves](lowdim-plot-2d-waves-1.png)

```r
wave_points(all_waves, names(ranges2d))
```

![plot of chunk plot-2d-waves](lowdim-plot-2d-waves-2.png)

```r
wave_values(all_waves, targets2d, l_wid = 0.8)
```

![plot of chunk plot-2d-waves](lowdim-plot-2d-waves-3.png)
